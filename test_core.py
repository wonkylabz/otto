...
class ClaudeMdBudgetTests(unittest.TestCase):
    ...
    # 81121 -> 82743 (#115 P4): Codex wired into the pipeline. The six rules are the ones a
    ...
    MAX_RULES_BYTES = 82743   # fetched tier — bounded, but looser; it is not always loaded
    MAX_RULE_CHARS = 280
