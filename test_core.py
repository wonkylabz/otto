...
class ClaudeMdBudgetTests(unittest.TestCase):
    ...
    # 81121 -> 82188 (#115 P4): Codex wired into the pipeline. The four rules are the ones a
    ...
    MAX_RULES_BYTES = 82188   # fetched tier — bounded, but looser; it is not always loaded
    MAX_RULE_CHARS = 280
