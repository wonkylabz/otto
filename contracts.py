...
_DIRECT_REPLY_FORMAT = (
    ...
    "in the message you can help with, answer them (or ask them) as above. And it never applies "
    "when YOUR own last turn asked them something or left a decision open — their reply is the "
    "answer you were waiting for, however brief or indirect, so say in one line what you are now "
